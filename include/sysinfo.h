...
#define PH_THREADINFO_TID     (1UL << 1U)
#define PH_THREADINFO_PRIO    (1UL << 2U)
#define PH_THREADINFO_STATE   (1UL << 3U)
#define PH_THREADINFO_LOAD    (1UL << 4U)
#define PH_THREADINFO_CPUTIME (1UL << 5U)
#define PH_THREADINFO_WAITING (1UL << 6U)
#define PH_THREADINFO_NAME    (1UL << 7U)
#define PH_THREADINFO_VMEM    (1UL << 8U)
#define PH_THREADINFO_PPID    (1UL << 9U)
...
#define PH_THREADINFO_OPT_THREADCOUNT (1UL << 10U)
