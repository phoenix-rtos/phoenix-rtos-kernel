...
#define PH_THREADINFO_TID     ((unsigned int)1UL << 0)
#define PH_THREADINFO_PRIO    ((unsigned int)1UL << 1)
#define PH_THREADINFO_STATE   ((unsigned int)1UL << 2)
#define PH_THREADINFO_LOAD    ((unsigned int)1UL << 3)
#define PH_THREADINFO_CPUTIME ((unsigned int)1UL << 4)
#define PH_THREADINFO_WAITING ((unsigned int)1UL << 5)
#define PH_THREADINFO_NAME    ((unsigned int)1UL << 6)
#define PH_THREADINFO_VMEM    ((unsigned int)1UL << 7)
#define PH_THREADINFO_PPID    ((unsigned int)1UL << 8)

#define PH_THREADINFO_BASIC ( \
		PH_THREADINFO_TID | \
		PH_THREADINFO_PRIO | \
		PH_THREADINFO_STATE | \
		PH_THREADINFO_LOAD | \
...
#define PH_THREADINFO_OPT_THREADCOUNT ((unsigned int)1UL << 9)
