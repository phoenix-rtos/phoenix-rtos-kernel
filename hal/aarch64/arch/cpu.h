...
#define SIZE_SP_EL1         128       /* This stack is only used in early stage of exception handling and can be small */
#define SIZE_INITIAL_KSTACK SIZE_PAGE /* Must be multiple of page size */
