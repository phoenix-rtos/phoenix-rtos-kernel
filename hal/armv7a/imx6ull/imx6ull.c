...
static int _imx6ull_setIOmux(int mux, char sion, char mode)
{
	...
	*(base + mux) = (unsigned int)(!!sion << 4) | ((unsigned int)mode & 0xfU);
...
static int _imx6ull_setIOpad(int pad, char hys, char pus, char pue, char pke, char ode, char speed, char dse, char sre)
{
	...
	t = ((u32) !!hys << 16) | (((u32)pus & 0x3U) << 14) | ((u32) !!pue << 13) | ((u32)!pke << 12);
	t |= ((u32) !!ode << 11) | (((u32)speed & 0x3U) << 6) | (((u32)dse & 0x7U) << 3) | (u32) !!sre;
	*(base + pad) = t;
...
static int _imx6ull_getIOpad(int pad, char *hys, char *pus, char *pue, char *pke, char *ode, char *speed, char *dse, char *sre)
{
	...
	*hys = (char)(u32)((t >> 16) & 0x1U);
	*pus = (char)(u32)((t >> 14) & 0x3U);
	*pue = (char)(u32)((t >> 13) & 0x1U);
	*pke = (char)(u32)((t >> 12) & 0x1U);
	*ode = (char)(u32)((t >> 11) & 0x1U);
	*speed = (char)(u32)((t >> 6) & 0x3U);
	*dse = (char)(u32)((t >> 3) & 0x7U);
	*sre = (char)(u32)(t & 0x1U);
...
static int _imx6ull_getIOisel(int isel, char *daisy)
{
	...
	*daisy = (char)(u32)(*(imx6ull_common.iomux + isel) & 0x7U);
