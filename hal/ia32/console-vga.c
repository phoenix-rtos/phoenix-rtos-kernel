...
static void _hal_consolePrint(const char *s)
{
	...
	while ((c = *s++) != '\0') {
			...
			switch (halconsole_common.esc) {
				...
				case esc_csi:
					switch (c) {
						...
						case '8':
						case '9':
							halconsole_common.parms[halconsole_common.parmi] *= 10U;
							halconsole_common.parms[halconsole_common.parmi] += ((unsigned char)c - (unsigned char)'0');
							break;

						case ';':
							if (halconsole_common.parmi + 1U < (unsigned char)sizeof(halconsole_common.parms)) {
						...
						case 'H':
							if (halconsole_common.parms[0] < 1U) {
								halconsole_common.parms[0] = 1;
							}
							else if (halconsole_common.parms[0] > halconsole_common.rows) {
								halconsole_common.parms[0] = (unsigned char)halconsole_common.rows;
							}
							else {
								/* No action required */
							}

							if (halconsole_common.parms[1] < 1U) {
								halconsole_common.parms[1] = 1;
							}
							else if (halconsole_common.parms[1] > halconsole_common.cols) {
								halconsole_common.parms[1] = (unsigned char)halconsole_common.cols;
							}
							else {
								/* No action required */
							}

							row = (unsigned int)halconsole_common.parms[0] - 1U;
							col = (unsigned int)halconsole_common.parms[1] - 1U;
							halconsole_common.esc = esc_init;
							break;
						...
						case 'm':
							...
							do {
								switch (halconsole_common.parms[i]) {
									...
									case 36:
									case 37:
										halconsole_common.attr = (halconsole_common.attr & 0xf0U) | ansi2fg[(halconsole_common.parms[i] - 30U) & 0x7U];
										break;
									...
									case 46:
									case 47:
										halconsole_common.attr = ansi2bg[(halconsole_common.parms[i] - 40U) & 0x7U] | (halconsole_common.attr & 0x0fU);
										break;
		...
		*((u8 *)(halconsole_common.vram + i) + 1U) = halconsole_common.attr;
	}
