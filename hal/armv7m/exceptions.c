...
static struct {
	void (*handler)(unsigned int n, exc_context_t *ctx);
} hal_exception_common;


/* parasoft-suppress-next-line MISRAC2012-RULE_8_6 "Definition in assembly" */
extern void hal_exceptionJump(unsigned int n, exc_context_t *ctx, void (*handler)(unsigned int n, exc_context_t *ctx));
