...
static const struct {
	...
	{ 0x34200000U, 0x343bffffU, risaf_npu_mst1, 0x0U, 0xffU, 0xffU, 1 }, /* AXISRAM3~6 are accessed by the NPU */
	...
	{ 0x580df000U, 0x580dffffU, risaf_cache_config, 0x0U, 0xffU, 0xffU, 1 },
	...
	{ 0x90000000U, 0x9fffffffU, risaf_npu_mst1, 0x0U, 0xffU, 0xffU, 1 }, /* PSRAM is accessed by the NPU */
};
