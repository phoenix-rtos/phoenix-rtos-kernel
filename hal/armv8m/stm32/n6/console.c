...
#define UART_IO_PORT_DEV CONCAT(pctl_dev_, UART_IO_PORT)
...
void _hal_consoleInit(void)
{
	struct {
		...
		{ ((void *)0x52001000), pctl_dev_usart1, pctl_ipclk_usart1sel },
		{ ((void *)0x50004400), pctl_dev_usart2, pctl_ipclk_usart2sel },
		{ ((void *)0x50004800), pctl_dev_usart3, pctl_ipclk_usart3sel },
		{ ((void *)0x50004c00), pctl_dev_uart4, pctl_ipclk_uart4sel },
		{ ((void *)0x50005000), pctl_dev_uart5, pctl_ipclk_uart5sel },
		{ ((void *)0x52001400), pctl_dev_usart6, pctl_ipclk_usart6sel },
		{ ((void *)0x50007800), pctl_dev_uart7, pctl_ipclk_uart7sel },
		{ ((void *)0x50007c00), pctl_dev_uart8, pctl_ipclk_uart8sel },
		{ ((void *)0x52001800), pctl_dev_uart9, pctl_ipclk_uart9sel },
		{ ((void *)0x52001c00), pctl_dev_usart10, pctl_ipclk_usart10sel },
	};

	const int uart = UART_CONSOLE_KERNEL, port = UART_IO_PORT_DEV, txpin = UART_PIN_TX, rxpin = UART_PIN_RX, af = UART_IO_AF;
