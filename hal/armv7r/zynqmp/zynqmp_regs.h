...
enum {
	iou_slcr_mio_pin_0 = 0x0UL,    /* 78 registers */
	iou_slcr_bank0_ctrl0 = 0x4eUL, /* 6 registers */
	iou_slcr_bank0_status = 0x54UL,
	iou_slcr_bank1_ctrl0, /* 6 registers */
	iou_slcr_bank1_status = 0x5bUL,
	iou_slcr_bank2_ctrl0, /* 6 registers */
	iou_slcr_bank2_status = 0x62UL,
	iou_slcr_mio_loopback = 0x80UL,
	iou_slcr_mio_mst_tri0, /* 3 registers */
	iou_slcr_wdt_clk_sel = 0xc0UL,
	...
	iou_slcr_sd_maxcur1p8 = 0xd3UL,
	iou_slcr_sd_maxcur3p0,
	iou_slcr_sd_maxcur3p1,
	iou_slcr_sd_dll_ctrl,
	iou_slcr_sd_cdn_ctrl,
	iou_slcr_gem_ctrl,
	iou_slcr_iou_ttc_apb_clk = 0xe0UL,
	iou_slcr_iou_tapdly_bypass = 0xe4UL,
	iou_slcr_iou_coherent_ctrl = 0x100UL,
	iou_slcr_video_pss_clk_sel,
	iou_slcr_iou_interconnect_route,
	iou_slcr_ctrl = 0x180UL,
	iou_slcr_isr = 0x1c0UL,
	iou_slcr_imr,
	iou_slcr_ier,
	iou_slcr_idr,
	iou_slcr_itr,
...
enum {
	...
	apu_rvbaraddr3h,
	apu_ace_ctrl,
	apu_snoop_ctrl = 0x20UL,
	apu_pwrctl = 0x24UL,
	apu_pwrstat,
};

enum {
	crf_apb_err_ctrl = 0x0UL,
	crf_apb_ir_status,
	crf_apb_ir_mask,
	crf_apb_ir_enable,
	crf_apb_ir_disable,
	crf_apb_crf_wprot = 0x7UL,
	crf_apb_apll_ctrl,
	crf_apb_apll_cfg,
	...
	crf_apb_acpu_ctrl = 0x18UL,
	crf_apb_dbg_trace_ctrl,
	crf_apb_dbg_fpd_ctrl,
	crf_apb_dp_video_ref_ctrl = 0x1cUL,
	crf_apb_dp_audio_ref_ctrl,
	crf_apb_dp_stc_ref_ctrl = 0x1fUL,
	crf_apb_ddr_ctrl,
	crf_apb_gpu_ref_ctrl,
	crf_apb_sata_ref_ctrl = 0x28UL,
	crf_apb_pcie_ref_ctrl = 0x2dUL,
	crf_apb_fpd_dma_ref_ctrl,
	crf_apb_dpdma_ref_ctrl,
	crf_apb_topsw_main_ctrl,
	crf_apb_topsw_lsbus_ctrl,
	crf_apb_dbg_tstmp_ctrl = 0x3eUL,
	crf_apb_rst_fpd_top = 0x40UL,
	crf_apb_rst_fpd_apu,
	crf_apb_rst_ddr_ss,
};

enum {
	crl_apb_err_ctrl = 0x0UL,
	crl_apb_ir_status,
	crl_apb_ir_mask,
	crl_apb_ir_enable,
	crl_apb_ir_disable,
	crl_apb_crl_wprot = 0x7UL,
	crl_apb_iopll_ctrl,
	crl_apb_iopll_cfg,
	crl_apb_iopll_frac_cfg,
	crl_apb_rpll_ctrl = 0xcUL,
	crl_apb_rpll_cfg,
	crl_apb_rpll_frac_cfg,
	crl_apb_pll_status = 0x10UL,
	...
	crl_apb_cpu_r5_ctrl = 0x24UL,
	crl_apb_iou_switch_ctrl = 0x27UL,
	...
	crl_apb_pl3_thr_cnt = 0x3fUL,
	crl_apb_gem_tsu_ref_ctrl,
	crl_apb_dll_ref_ctrl,
	crl_apb_pssysmon_ref_ctrl,
	crl_apb_i2c0_ref_ctrl = 0x48UL,
	crl_apb_i2c1_ref_ctrl,
	crl_apb_timestamp_ref_ctrl,
	crl_apb_safety_chk = 0x4cUL,
	crl_apb_clkmon_status = 0x50UL,
	crl_apb_clkmon_mask,
	crl_apb_clkmon_enable,
	crl_apb_clkmon_disable,
	crl_apb_clkmon_trigger,
	crl_apb_chkr0_clka_upper = 0x58UL, /* 8 banks of 4 registers */
	crl_apb_chkr0_clka_lower,
	crl_apb_chkr0_clkb_cnt,
	crl_apb_chkr0_ctrl,
	crl_apb_boot_mode_user = 0x80UL,
	crl_apb_boot_mode_por,
	crl_apb_reset_ctrl = 0x86UL,
	crl_apb_blockonly_rst,
	crl_apb_reset_reason,
	crl_apb_rst_lpd_iou0 = 0x8cUL,
	crl_apb_rst_lpd_iou2 = 0x8eUL,
	crl_apb_rst_lpd_top,
	crl_apb_rst_lpd_dbg,
	crl_apb_boot_pin_ctrl = 0x94UL,
	crl_apb_bank3_ctrl0 = 0x9cUL, /* 6 registers */
	crl_apb_bank3_status = 0xa2UL,
};
