...
{
	u32 reg = pin / 32U + iou_slcr_mio_mst_tri0;
	u32 bit = pin % 32U;
	u32 mask = 0x01UL << bit;
...
{
	u32 reg = (pin / 26U) * (iou_slcr_bank1_ctrl0 - iou_slcr_bank0_ctrl0) + iou_slcr_bank0_ctrl0;
	u32 bit = pin % 26U;
	u32 mask = 0x01UL << bit;
	unsigned int i;
...
static int _zynqmp_parseReset(int dev, volatile u32 **reg, u32 *bit)
{
	static const u32 lookup[] = {
		[pctl_devreset_lpd_gem0] = crl_apb_rst_lpd_iou0 | (0UL << 12),
		[pctl_devreset_lpd_gem1] = crl_apb_rst_lpd_iou0 | (1UL << 12),
		[pctl_devreset_lpd_gem2] = crl_apb_rst_lpd_iou0 | (2UL << 12),
		[pctl_devreset_lpd_gem3] = crl_apb_rst_lpd_iou0 | (3UL << 12),
		[pctl_devreset_lpd_qspi] = crl_apb_rst_lpd_iou2 | (0UL << 12),
		[pctl_devreset_lpd_uart0] = crl_apb_rst_lpd_iou2 | (1UL << 12),
		[pctl_devreset_lpd_uart1] = crl_apb_rst_lpd_iou2 | (2UL << 12),
		[pctl_devreset_lpd_spi0] = crl_apb_rst_lpd_iou2 | (3UL << 12),
		[pctl_devreset_lpd_spi1] = crl_apb_rst_lpd_iou2 | (4UL << 12),
		[pctl_devreset_lpd_sdio0] = crl_apb_rst_lpd_iou2 | (5UL << 12),
		[pctl_devreset_lpd_sdio1] = crl_apb_rst_lpd_iou2 | (6UL << 12),
		[pctl_devreset_lpd_can0] = crl_apb_rst_lpd_iou2 | (7UL << 12),
		[pctl_devreset_lpd_can1] = crl_apb_rst_lpd_iou2 | (8UL << 12),
		[pctl_devreset_lpd_i2c0] = crl_apb_rst_lpd_iou2 | (9UL << 12),
		[pctl_devreset_lpd_i2c1] = crl_apb_rst_lpd_iou2 | (10UL << 12),
		[pctl_devreset_lpd_ttc0] = crl_apb_rst_lpd_iou2 | (11UL << 12),
		[pctl_devreset_lpd_ttc1] = crl_apb_rst_lpd_iou2 | (12UL << 12),
		[pctl_devreset_lpd_ttc2] = crl_apb_rst_lpd_iou2 | (13UL << 12),
		[pctl_devreset_lpd_ttc3] = crl_apb_rst_lpd_iou2 | (14UL << 12),
		[pctl_devreset_lpd_swdt] = crl_apb_rst_lpd_iou2 | (15UL << 12),
		[pctl_devreset_lpd_nand] = crl_apb_rst_lpd_iou2 | (16UL << 12),
		[pctl_devreset_lpd_lpd_dma] = crl_apb_rst_lpd_iou2 | (17UL << 12),
		[pctl_devreset_lpd_gpio] = crl_apb_rst_lpd_iou2 | (18UL << 12),
		[pctl_devreset_lpd_iou_cc] = crl_apb_rst_lpd_iou2 | (19UL << 12),
		[pctl_devreset_lpd_timestamp] = crl_apb_rst_lpd_iou2 | (20UL << 12),
		[pctl_devreset_lpd_rpu_r50] = crl_apb_rst_lpd_top | (0UL << 12),
		[pctl_devreset_lpd_rpu_r51] = crl_apb_rst_lpd_top | (1UL << 12),
		[pctl_devreset_lpd_rpu_amba] = crl_apb_rst_lpd_top | (2UL << 12),
		[pctl_devreset_lpd_ocm] = crl_apb_rst_lpd_top | (3UL << 12),
		[pctl_devreset_lpd_rpu_pge] = crl_apb_rst_lpd_top | (4UL << 12),
		[pctl_devreset_lpd_usb0_corereset] = crl_apb_rst_lpd_top | (6UL << 12),
		[pctl_devreset_lpd_usb1_corereset] = crl_apb_rst_lpd_top | (7UL << 12),
		[pctl_devreset_lpd_usb0_hiberreset] = crl_apb_rst_lpd_top | (8UL << 12),
		[pctl_devreset_lpd_usb1_hiberreset] = crl_apb_rst_lpd_top | (9UL << 12),
		[pctl_devreset_lpd_usb0_apb] = crl_apb_rst_lpd_top | (10UL << 12),
		[pctl_devreset_lpd_usb1_apb] = crl_apb_rst_lpd_top | (11UL << 12),
		[pctl_devreset_lpd_ipi] = crl_apb_rst_lpd_top | (14UL << 12),
		[pctl_devreset_lpd_apm] = crl_apb_rst_lpd_top | (15UL << 12),
		[pctl_devreset_lpd_rtc] = crl_apb_rst_lpd_top | (16UL << 12),
		[pctl_devreset_lpd_sysmon] = crl_apb_rst_lpd_top | (17UL << 12),
		[pctl_devreset_lpd_s_axi_lpd] = crl_apb_rst_lpd_top | (19UL << 12),
		[pctl_devreset_lpd_lpd_swdt] = crl_apb_rst_lpd_top | (20UL << 12),
		[pctl_devreset_lpd_fpd] = crl_apb_rst_lpd_top | (23UL << 12),
		[pctl_devreset_lpd_dbg_fpd] = crl_apb_rst_lpd_dbg | (0UL << 12),
		[pctl_devreset_lpd_dbg_lpd] = crl_apb_rst_lpd_dbg | (1UL << 12),
		[pctl_devreset_lpd_rpu_dbg0] = crl_apb_rst_lpd_dbg | (4UL << 12),
		[pctl_devreset_lpd_rpu_dbg1] = crl_apb_rst_lpd_dbg | (5UL << 12),
		[pctl_devreset_lpd_dbg_ack] = crl_apb_rst_lpd_dbg | (15UL << 12),
		[pctl_devreset_fpd_sata] = crf_apb_rst_fpd_top | (1UL << 12),
		[pctl_devreset_fpd_gt] = crf_apb_rst_fpd_top | (2UL << 12),
		[pctl_devreset_fpd_gpu] = crf_apb_rst_fpd_top | (3UL << 12),
		[pctl_devreset_fpd_gpu_pp0] = crf_apb_rst_fpd_top | (4UL << 12),
		[pctl_devreset_fpd_gpu_pp1] = crf_apb_rst_fpd_top | (5UL << 12),
		[pctl_devreset_fpd_fpd_dma] = crf_apb_rst_fpd_top | (6UL << 12),
		[pctl_devreset_fpd_s_axi_hpc_0_fpd] = crf_apb_rst_fpd_top | (7UL << 12),
		[pctl_devreset_fpd_s_axi_hpc_1_fpd] = crf_apb_rst_fpd_top | (8UL << 12),
		[pctl_devreset_fpd_s_axi_hp_0_fpd] = crf_apb_rst_fpd_top | (9UL << 12),
		[pctl_devreset_fpd_s_axi_hp_1_fpd] = crf_apb_rst_fpd_top | (10UL << 12),
		[pctl_devreset_fpd_s_axi_hpc_2_fpd] = crf_apb_rst_fpd_top | (11UL << 12),
		[pctl_devreset_fpd_s_axi_hpc_3_fpd] = crf_apb_rst_fpd_top | (12UL << 12),
		[pctl_devreset_fpd_swdt] = crf_apb_rst_fpd_top | (15UL << 12),
		[pctl_devreset_fpd_dp] = crf_apb_rst_fpd_top | (16UL << 12),
		[pctl_devreset_fpd_pcie_ctrl] = crf_apb_rst_fpd_top | (17UL << 12),
		[pctl_devreset_fpd_pcie_bridge] = crf_apb_rst_fpd_top | (18UL << 12),
		[pctl_devreset_fpd_pcie_cfg] = crf_apb_rst_fpd_top | (19UL << 12),
		[pctl_devreset_fpd_acpu0] = crf_apb_rst_fpd_apu | (0UL << 12),
		[pctl_devreset_fpd_acpu1] = crf_apb_rst_fpd_apu | (1UL << 12),
		[pctl_devreset_fpd_acpu2] = crf_apb_rst_fpd_apu | (2UL << 12),
		[pctl_devreset_fpd_acpu3] = crf_apb_rst_fpd_apu | (3UL << 12),
		[pctl_devreset_fpd_apu_l2] = crf_apb_rst_fpd_apu | (8UL << 12),
		[pctl_devreset_fpd_acpu0_pwron] = crf_apb_rst_fpd_apu | (10UL << 12),
		[pctl_devreset_fpd_acpu1_pwron] = crf_apb_rst_fpd_apu | (11UL << 12),
		[pctl_devreset_fpd_acpu2_pwron] = crf_apb_rst_fpd_apu | (12UL << 12),
		[pctl_devreset_fpd_acpu3_pwron] = crf_apb_rst_fpd_apu | (13UL << 12),
		[pctl_devreset_fpd_ddr_apm] = crf_apb_rst_ddr_ss | (2UL << 12),
		[pctl_devreset_fpd_ddr_reserved] = crf_apb_rst_ddr_ss | (3UL << 12),
	};
