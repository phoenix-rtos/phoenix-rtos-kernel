...
{
	if (msg->o.size <= min(sizeof(from->utcb.msgbuf) - MSG_RAW_SIZE, to->utcb.esize) && to->utcb.msg->edata != NULL) {
		/* REVISIT: can the if condition be simplified or matched closer to the proc_send edata setup? */
