...
int syscalls_beginthreadex(void *ustack)
{
	...
	GETFROMSTACK(ustack, start_func, start, 0U);
...
int syscalls_perf_start(void *ustack)
{
	...
	GETFROMSTACK(ustack, unsigned, pid, 0U);
...
int syscalls_interrupt(void *ustack)
{
	...
	GETFROMSTACK(ustack, handler_function, f, 1U);
...
int syscalls_signalHandle(void *ustack)
{
	...
	GETFROMSTACK(ustack, handler_func, handler, 0U);
	GETFROMSTACK(ustack, unsigned, mask, 1U);
	GETFROMSTACK(ustack, unsigned, mmask, 2U);
...
unsigned int syscalls_signalMask(void *ustack)
{
	...
	GETFROMSTACK(ustack, unsigned, mask, 0U);
	GETFROMSTACK(ustack, unsigned, mmask, 1U);
