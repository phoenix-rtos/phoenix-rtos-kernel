...
addr_t vm_phAlloc(size_t *size, page_flags_t page_flags, vm_flags_t vm_flags, syspage_part_t *part);


int vm_phFree(addr_t addr, size_t size, syspage_part_t *part);
