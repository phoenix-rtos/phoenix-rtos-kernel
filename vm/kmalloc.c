...
static vm_zone_t *_kmalloc_free(u8 hdridx, void *p, partition_t *part)
{
	vm_zone_t t;
	vm_zone_t *z;
	u8 idx;
...
static void *_kmalloc_freeAtom(u8 hdridx, void *p, partition_t *part)
{
	vm_zone_t *z;
	u8 idx;
...
void vm_kfree(void *p, partition_t *part)
{
	u8 hdridx;
