...
static void _emitThreadsCb(threadinfo_t *tinfo, void *private)
{
	struct {
		u16 pid;
		u16 tid;
...
{
	(void)proc_threadsIter(PH_THREADINFO_TID | PH_THREADINFO_PRIO | PH_THREADINFO_NAME, _emitThreadsCb, NULL);
}
