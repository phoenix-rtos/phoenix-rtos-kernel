...
extern void perf_traceEventsWrite(u8 event, void *data, size_t sz);
...
static inline void perf_traceEventsLockClear(lock_t *lock, u32 tid)
{
	struct {
		u32 tid;
		u32 lid;
...
static inline void perf_traceEventsThreadCreate(thread_t *t)
{
	struct {
		u32 pid;
		u32 tid;
...
static inline void perf_traceEventsThreadEnd(thread_t *t)
{
	struct {
		u32 pid;
		u32 tid;
